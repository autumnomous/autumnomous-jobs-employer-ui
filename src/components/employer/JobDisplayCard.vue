<template>
    ...
    <div class="card-body">
        ...
        <div class="media-body">
            ...
            <div class="col-12 col-md mt-3 mt-md-0">
                <span class="d-block font-size-1 text-body mb-1">${{job.minsalary}}-${{job.maxsalary}} per {{job.payperiod}}</span>
            </div>
            </div>
            <!-- End Row -->
        </div>
    ...
    <div class="card-footer">
        <ul class="list-inline list-separator small text-body">
            <li class="list-inline-item">{{prettyDate(job.poststartdatetime)}} - {{prettyDate(job.postenddatetime)}}</li>
