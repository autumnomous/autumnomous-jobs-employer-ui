  ...
  <div class="home">
    ...
    <div class="position-relative gradient-x-three-sm-primary rounded-lg space-top-md-1 space-bottom-md-2 mx-md-10">
      <div class="container position-relative space-top-2 space-top-lg-3 space-bottom-1">
        ...
        <div class="d-none d-lg-block col-lg-6 position-lg-absolute top-0 right-0">
          <img class="img-fluid rounded-lg" src="../../public/assets/img/900x900/img23.jpg" alt="Image Description">
          ...
          <div class="d-flex align-items-center">
            ...
            <img class="avatar avatar-ratio" src="https://via.placeholder.com/10" alt="Image Description">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container space-2 space-top-lg-4 space-bottom-lg-3">
      ...
      <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-7">
        ...
        <p>Find a job you love. <a class="font-weight-bold" href="#">Set your career interests.</a></p>
      </div>
      <!-- End Title -->
              ...
              <div class="row mb-3">
                <div class="col">
                  <div class="media align-items-center">
                    <img class="avatar avatar-sm mr-3" src="../../public/assets/svg/brands/mailchimp.svg" alt="Image Description">
                    <div class="media-body">
                      <h6 class="mb-0">
                        <a class="text-dark" href="employer.html">Mailchimp</a>
                        <img class="avatar avatar-xss ml-1" src="../../public/assets/svg/illustrations/top-vendor.svg" alt="Review rating" data-toggle="tooltip" data-placement="top" title="Claimed profile">
                      </h6>
                    </div>
                  </div>
                </div>
          ...
          <div class="card card-bordered card-hover-shadow h-100">
            <div class="card-body">
              <div class="row mb-3">
                <div class="col">
                  <div class="media align-items-center">
                    <img class="avatar avatar-sm mr-3" src="../../public/assets/svg/brands/capsule.svg" alt="Image Description">
                    <div class="media-body">
                      <h6 class="mb-0">
          ...
          <div class="card card-bordered card-hover-shadow h-100">
            <div class="card-body">
              <div class="row mb-3">
                <div class="col">
                  <div class="media align-items-center">
                    <img class="avatar avatar-sm mr-3" src="../../public/assets/svg/brands/spec.svg" alt="Image Description">
                    <div class="media-body">
                      <h6 class="mb-0">
          ...
          <div class="card card-bordered card-hover-shadow h-100">
            <div class="card-body">
              <div class="row mb-3">
                <div class="col">
                  <div class="media align-items-center">
                    <img class="avatar avatar-sm mr-3" src="../../public/assets/svg/brands/prosperops.svg" alt="Image Description">
                    <div class="media-body">
                      <h6 class="mb-0">
                        <a class="text-dark" href="employer.html">Prosperops</a>
                      </h6>
                    </div>
                  </div>
                </div>
              ...
              <h3 class="mb-3">
                <a class="text-dark" href="employer.html">Senior backend developer</a>
              </h3>
          ...
          <div class="card card-bordered card-hover-shadow h-100">
            <div class="card-body">
              <div class="row mb-3">
                <div class="col">
                  <div class="media align-items-center">
                    <img class="avatar avatar-sm mr-3" src="../../public/assets/svg/brands/figma.svg" alt="Image Description">
                    <div class="media-body">
                      <h6 class="mb-0">
                        <a class="text-dark" href="employer.html">Figma</a>
                        <img class="avatar avatar-xss ml-1" src="../../public/assets/svg/illustrations/top-vendor.svg" alt="Review rating" data-toggle="tooltip" data-placement="top" title="Claimed profile">
                      </h6>
                    </div>
                  </div>
              ...
              <h3 class="mb-3">
                <a class="text-dark" href="employer.html">Senior product manager</a>
              </h3>
          ...
          <div class="card card-bordered card-hover-shadow h-100">
            <div class="card-body">
              <div class="row mb-3">
                <div class="col">
                  <div class="media align-items-center">
                    <img class="avatar avatar-sm mr-3" src="../../public/assets/svg/brands/guideline.svg" alt="Image Description">
                    <div class="media-body">
                      <h6 class="mb-0">
                        <a class="text-dark" href="employer.html">Guideline</a>
                      </h6>
                    </div>
                  </div>
                </div>
              ...
              <h3 class="mb-3">
                <a class="text-dark" href="employer.html">iOS Engineer</a>
              </h3>
      ...
      <div class="text-center">
        <a class="btn btn-link" href="job-list.html">View all jobs <i class="fas fa-angle-right ml-1"></i></a>
      </div>
    </div>
    <!-- End Listing Section -->
        ...
        <div class="row justify-content-center align-items-lg-center">
          <div class="col-10 col-sm-8 col-lg-5 mb-11 mb-lg-0">
            <div class="position-relative">
              <img class="img-fluid rounded-lg" src="../../public/assets/img/900x900/img24.jpg" alt="Image Description">
          ...
          <div class="col-lg-7">
            <div class="pl-lg-6">
              <img class="avatar mb-3" src="../../public/assets/svg/brands/capsule.svg" alt="Image Description">
    ...
    <div class="container space-2 space-lg-3">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-3 mb-sm-5">
          ...
          <a class="card card-bordered card-hover-shadow h-100" href="job-overview.html">
            <div class="card-body">
              <div class="media">
                <div class="media-body">
                  <h5 class="text-hover-primary mb-0">UI Designer</h5>
                  <small class="text-body">37 job positions</small>
                </div>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-3 mb-sm-5">
          ...
          <a class="card card-bordered card-hover-shadow h-100" href="job-overview.html">
            <div class="card-body">
              <div class="media">
                <div class="media-body">
                  <h5 class="text-hover-primary mb-0">Apps</h5>
                  <small class="text-body">2 job positions</small>
                </div>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-3 mb-sm-5">
          ...
          <a class="card card-bordered card-hover-shadow h-100" href="job-overview.html">
            <div class="card-body">
              <div class="media">
                <div class="media-body">
                  <h5 class="text-hover-primary mb-0">Content Writer</h5>
                  <small class="text-body">10 job positions</small>
                </div>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-3 mb-sm-5">
          ...
          <a class="card card-bordered card-hover-shadow h-100" href="job-overview.html">
            <div class="card-body">
              <div class="media">
                <div class="media-body">
                  <h5 class="text-hover-primary mb-0">Analytics</h5>
                  <small class="text-body">14 job positions</small>
                </div>
      ...
      <div class="text-center">
        <a class="btn btn-link" href="job-list.html">View all startups <i class="fas fa-angle-right ml-1"></i></a>
      </div>
    </div>
    <!-- End Listing Section -->
  </main>
